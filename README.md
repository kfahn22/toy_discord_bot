...
- The convention is to name the file is the name of the slash command, for example for `choochoo.js`
...
[Sequelize](https://discordjs.guide/sequelize/#installing-and-using-sequelize)
